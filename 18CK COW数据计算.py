...
out_columns=['LOP1','VF1','WLD1','VZ1','VF3','VF4','HW1','LOP1良率','VF1良率','WLD1良率','VZ1良率','IR良率','VF3良率','HW1良率','测试颗数','好晶','R仓数']
DF_Average={'VF1':[2,5],'LOP1':[20,200],'WLD1':[430,480],'VZ1':[10,200],'VF3':[1,4],'HW1':[5,50]}                                   # 计算均值
DF_Yield={'VF1':[2.8,3.3],'LOP1':[75,200],'WLD1':[444,462],'IR':[0,0.2],'VZ1':[28,200],'VF3':[2,2.5],'HW1':[15,27]}           # 计算良率
